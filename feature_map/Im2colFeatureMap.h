...
public:
    ...
    OutputMap<T> * conv(Im2colKernel * im2Kernel);
...
template<typename T>
OutputMap<T> *Im2colFeatureMap<T>::conv(Im2colKernel * im2Kernel) {
    int K = im2Kernel->K;
...
template<typename T>
OutputMap<T> *Im2colFeatureMap<T>::conv(Im2colKernel *im2Kernel, AcceleratorFunction * accFunction) {
